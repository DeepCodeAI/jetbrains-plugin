...
public abstract class ChangeListTodosPanel extends TodoPanel{
  ...
  private final class MyChangeListManagerListener extends ChangeListAdapter {
    ...
    public void defaultListChanged(final ChangeList oldDefaultList, final ChangeList newDefaultList) {
      ...
      AppUIUtil.invokeOnEdt(() -> setDisplayName(myTodoView.getTabNameForChangeList(newDefaultList.getName())));
    }

    @Override
    public void changeListRenamed(final ChangeList list, final String oldName) {
      AppUIUtil.invokeOnEdt(() -> setDisplayName(myTodoView.getTabNameForChangeList(list.getName())));
    }
