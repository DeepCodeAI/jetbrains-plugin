...
//      }
    ...
    Editor myEditor = ConsoleViewUtil.setupConsoleEditor(project, false, false);
    Disposer.register(this, () -> {
      EditorFactory.getInstance().releaseEditor(myEditor);
    });

    editorPanel.add(myEditor.getComponent());
    ...
    Content currentFileContent = contentFactory.createContent(currentFilePanel, "Current File", false);
